...
This depends on at least Python version 3.4.
...
# Download some third-party libraries:
./get-libraries.sh

# Create a virtualenv using Python 3.4 (adjust to suit your environment):
...
# To run it for only local access:
./manage.py runserver

# Or, use this to run it so that outside machines can access it:
